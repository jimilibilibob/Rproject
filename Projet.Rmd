...
Concernant le perimetre des données, nous privilegions des jointures internes entre les tables, permettant de determiner si l'unification des données engendre une perte de volumetrie.
...
Concernant le perimetre des données, nous privilegions d'afficher tous les articles, meme si ces derniers n'ont pas générés de marge. 
Le constat d'analyse est le suivant :
