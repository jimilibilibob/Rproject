...
## Initatialisation du formattable :
Création des formatters:
 - Un peu la couleur des textes
 - Un pour l'indices d'évolutions
```{r}
...
## Création du formattable :
Création du formattable avec les formatters précédéments cités et avec une color bar pour le nombre d'adherent
```{r}
